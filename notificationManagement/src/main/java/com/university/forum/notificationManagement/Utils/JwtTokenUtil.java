package com.university.forum.notificationManagement.Utils;
...
public class JwtTokenUtil {
    ...
    public UUID getUserIdFromToken(String token) {
        ...
        try {
            ...
            return UUID.fromString(userIdString);        } catch (JwtException e) {
            throw new IllegalArgumentException("Invalid token or unable to parse", e);
        }
    }
    ...
    public String getTokenTypeFromToken(String token) {
        ...
        try {
            Claims claims = Jwts.parserBuilder()
                    ...
                    .parseClaimsJws(token)
                    .getBody();
            return claims.get("tokenType", String.class);  // Get token type from claims
        } catch (JwtException e) {
            throw new IllegalArgumentException("Invalid token or unable to parse", e);
        }
    }
