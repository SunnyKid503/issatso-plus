...
public class CloudinaryService {
    ...
    public FileReference uploadFileToFolder(MultipartFile file, String folderPath) throws IOException {
        ...
        return new FileReference(secureUrl,returnedPublicId);
    }
    ...
    public boolean deleteFile(String publicId) throws IOException {
        ...
        return deleteResult.get("result").toString().equals("ok"); // "ok" indicates a successful deletion
    }
