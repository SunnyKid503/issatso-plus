...
public class ProfessorMessage implements Serializable {
    ...
    private Boolean sex;
    private MemberType memberType=MemberType.PROFESSOR;
    ...
    public ProfessorMessage(UUID id, String firstName, String lastName, String addressEmail, String phoneNumber, String address, String linkedInProfileUrl, String profileImageUrl, String cin, LocalDate dob, Set<Integer> classGroupIds, Set<Integer> roleIds, Boolean sex, MemberType memberType) {
        Id = id;
